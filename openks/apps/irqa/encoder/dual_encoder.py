...
from openks.apps.irqa.reader import reader_de_predict, reader_de_train
from openks.apps.irqa.model.ernie import ErnieConfig
from openks.apps.irqa.model.dual_encoder_predict import create_predict_model
from openks.apps.irqa.model.dual_encoder_train import create_train_model
from openks.apps.irqa.utils.args import print_arguments, check_cuda, prepare_logger
from openks.apps.irqa.utils.init import init_pretraining_params, init_checkpoint
...
class DualEncoder(object):
    ...
    def __init__(self, conf_path, use_cuda=False, device_id=0, batch_size=1, **kwargs):
        ...
        """
        self.train_reader = reader_de_train.DETrainReader(
            vocab_path=args.vocab_path,
            label_map_config=args.label_map_config,
            q_max_seq_len=args.q_max_seq_len,
            p_max_seq_len=args.p_max_seq_len,
    ...
    def train(self, config_path):
        ...
        if self.args.init_checkpoint and self.args.init_pretraining_params:
            log.warning(
        ...
        if self.args.use_fast_executor:
            exec_strategy.use_experimental_executor = True
        exec_strategy.num_threads = dev_count
        exec_strategy.num_iteration_per_drop_scope = self.args.num_iteration_per_drop_scope
