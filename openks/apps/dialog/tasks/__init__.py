...
def add_cmdline_args(parser):
    ...
    group.add_argument("--task", type=str, default="DialogGeneration")
...
import openks.apps.dialog.tasks.dialog_generation
import openks.apps.dialog.tasks.next_sentence_prediction
