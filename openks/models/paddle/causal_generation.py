...
@Causal_GenerationModel.register("Causal_Generation","Paddle")
class Causality_ExtractionPaddle(Causal_GenerationModel):
    '''Base class for event extract trainer'''

    def __init__(self, args, name: str = 'Causal_GenerationModel'):
        self.name = name
        self.args = args
