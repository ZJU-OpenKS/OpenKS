...
class GnnEventModel_withattention_nohisupdate(BasicModel):
    ...
    def get_log_file(self):
        log_file = 'h_' + str(self.params['hidden_size']) + '_b_' + str(self.params['batch_event_numbers']) \
                    ...
                    + str(self.params['max_his_num']) + '_n_' + str(self.params['negative_ratio_pertype']) + '_with_attention_nohisupdate.log'
        return log_file
    ...
    def get_checkpoint_dir(self):
        checkpoint_dir = 'h_' + str(self.params['hidden_size']) + '_b_' + str(self.params['batch_event_numbers']) \
                    + '_l_' + str(self.params['learning_rate']) + '_d_' + str(self.params['decay']) + '_ds_' \
                    + str(self.params['decay_step']) + '_k_' + str(self.params['keep_prob']) + '_'+str(self.params['his_type'])+'_'\
                    + str(self.params['max_his_num']) + '_n_' + str(self.params['negative_ratio_pertype']) + '_with_attention_nohisupdate'
...
######################################################
    ...
    def build_specific_graph_model(self):
        ...
        for event_id in range(self._eventnum_batch):
            ...
            neg_event_states_stacked1 = [None for _ in range(self._neg_num)]
            ...
            for neg in range(self._neg_num):
                ...
                # neg_event_states_stacked1[neg] = tf.reduce_sum(neg_event_states, 0)
            # negevent_states_list.append(tf.stack(neg_event_states_stacked1))
