...
class GnnEventModel_withattention(BasicModel):
    ...
    def get_log_file(self):
        log_file = 'h_' + str(self.params['hidden_size']) + '_b_' + str(self.params['batch_event_numbers']) \
                    ...
                    + str(self.params['max_his_num']) + '_n_' + str(self.params['negative_ratio_pertype']) + '_with_attention1.log'
        return log_file
    ...
    def get_checkpoint_dir(self):
        checkpoint_dir = 'h_' + str(self.params['hidden_size']) + '_b_' + str(self.params['batch_event_numbers']) \
                    + '_l_' + str(self.params['learning_rate']) + '_d_' + str(self.params['decay']) + '_ds_' \
                    + str(self.params['decay_step']) + '_k_' + str(self.params['keep_prob']) + '_'+str(self.params['his_type'])+'_'\
                    + str(self.params['max_his_num']) + '_n_' + str(self.params['negative_ratio_pertype']) + '_with_attention1'
...
######################################################
    ...
    def build_specific_graph_model(self):
        ...
        # node_vec[0] = tf.where(self.placeholders['is_init'], self._embedding_init, self.placeholders['nodes_embedding_ph'])
        ...
        # node_cel[0] = tf.where(self.placeholders['is_init'], self._cellstates_init, self.placeholders['nodes_cellstates_ph'])
        event_pred_list = []
        neg_event_pred_list = []
    ...
    def get_batch_feed_dict(self, state, is_init):
        ...
        # print(batch_feed_dict[self.placeholders['is_init']][batch_data[0][0][0]])
        # print(batch_feed_dict[self.placeholders['is_init']][batch_data_neg[0][0][0][0]])
