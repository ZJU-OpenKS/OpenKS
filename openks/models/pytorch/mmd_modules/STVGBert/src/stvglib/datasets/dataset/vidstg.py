...
class vidstg(data.Dataset):
	...
	def __init__(self, opt, split):
		super(vidstg, self).__init__()
		self.data_dir = os.path.join(opt.data_dir, 'vidstg')
		...
		with open(os.path.join(self.data_dir, 'annotations', '{}_full_annotations.pkl'.format(split)), 'rb') as f:
