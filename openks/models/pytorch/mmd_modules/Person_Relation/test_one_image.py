...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--img_name", default='', help="path to img file", type=str
    )
    parser.add_argument(
        "--img_id", default='', help="path to img file", type=str
    )
    ...
    train_loader, train_loader_normal, val_loader, num_query, num_classes, camera_num, view_num = make_dataloader(cfg, args.img_name, args.img_id)
