...
#sys.path.append(os.path.join(os.getcwd(), os.pardir, "openks/models/pytorch/mmd_modules/ThreeDVG")) # HACK add the lib folder

from openks.models.pytorch.mmd_modules.ThreeDVG.lib.config import CONF
