...
class TUDataset_aug(InMemoryDataset):
    ...
    def __init__(self, root, name, transform=None, pre_transform=None, pre_filter=None, 
                 ...
                 cleaned=False, aug=None, aug_ratio=0.3):
        self.name = name
        ...
        if not (self.name == 'MUTAG' or self.name == 'PTC_MR' or self.name == 'DD' \
            or self.name == 'PROTEINS' or self.name == 'NCI1' or self.name == 'NCI109' \
                or self.name == 'FIRSTMM_DB' or self.name == 'ENZYMES' or self.name == 'Cuneiform' or self.name == 'MSRC_21'):
