...
from GraKeL.grakel.kernels.weisfeiler_lehman import WeisfeilerLehman
from GraKeL.grakel.kernels.shortest_path import ShortestPath
from GraKeL.grakel.kernels.graphlet_sampling import GraphletSampling
